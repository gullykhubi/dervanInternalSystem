...
if ($conn->query($sql) === TRUE) {
	...
	if($type == 'ind'){
		...
		if ($conn->query($sql1) === TRUE) {
			...
			$sql6="INSERT INTO `TEAM_PARTI`(`TEAM_ID`, `PART_ID`) VALUES (".$team_id.",".$last_id.")";
